...
/// </para>
/// </remarks>
[AggregateType("SubscriptionDecision", version: 2)]
public class SubscriptionDecision2 : DcbAggregateRoot
{
    ...
    /// </summary>
    public SubscriptionDecision2 About(string courseId, string studentId)
    {
        CourseId = courseId;
        StudentId = studentId;
        return this;
