...
public static class DiagnosticsExtensions
{
    ...
    public static void AddActivityEvent<TAggregate>(this TransactionalBatchResponse batchResponse, IStreamId streamId, IAggregateId<TAggregate> aggregateId, string operation) where TAggregate : IAggregateRoot
    {
    ...
    /// <param name="aggregateId">The aggregate identifier.</param>
    /// <param name="operation">The operation being performed.</param>
    public static void AddActivityEvent<TAggregate>(this ItemResponse<AggregateDocument> itemResponse, IStreamId streamId, IAggregateId<TAggregate> aggregateId, string operation) where TAggregate : IAggregateRoot
    {
